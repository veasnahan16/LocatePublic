package com.example.veasnahan.locatepublic.data;
...
import com.example.veasnahan.locatepublic.model.CardViewImg;
import com.example.veasnahan.locatepublic.model.Image;
import com.example.veasnahan.locatepublic.model.Inbox;
import com.example.veasnahan.locatepublic.model.MusicAlbum;
import com.example.veasnahan.locatepublic.model.MusicSong;
import com.example.veasnahan.locatepublic.model.People;
import com.example.veasnahan.locatepublic.model.ShopCategory;
import com.example.veasnahan.locatepublic.model.ShopProduct;
import com.example.veasnahan.locatepublic.model.Social;
import com.example.veasnahan.locatepublic.utils.MaterialColor;
...
public class DataGenerator {
    ...
    public static List<Image> getImageDate(Context ctx) {
        ...
        for (int i = 0; i < drw_arr.length(); i++) {
            ...
            //obj.image = drw_arr.getResourceId(i, -1);
            obj.name = name_arr[i];
            Log.i ( "TAGG", name_arr[i].toString () );
