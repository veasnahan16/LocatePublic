...
import com.example.veasnahan.locatepublic.LocationUtil.PermissionUtils;
import com.example.veasnahan.locatepublic.LocationUtil.PermissionUtils.PermissionResultCallback;
...
public class MyLocationUsingLocationAPI extends AppCompatActivity implements ConnectionCallbacks, OnConnectionFailedListener, OnRequestPermissionsResultCallback, PermissionResultCallback {
...
//    @BindView(R.id.rlPickLocation)RelativeLayout rlPick;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnProceedd = findViewById ( R.id.btnLocation );
        RelativeLayout rl = findViewById ( R.id.rlPickLocation );
//        @BindView(R.id.tvAddress)TextView tvAddress;
//        @BindView(R.id.tvEmpty)TextView tvEmpty;
...
//                        btnProceed.setEnabled(false);
        ...
        btnProceedd.setOnClickListener ( new View.OnClickListener () {
            @Override
            public void onClick(View view) {
